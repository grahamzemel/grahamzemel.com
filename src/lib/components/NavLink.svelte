...
<a
  ...
  {...$$restProps}
  {href}
  class={'relative flex flex-row px-5 py-2 overflow-hidden font-bold text-zinc-500 rounded-lg border-[1.5px] !border-[#666666] shadow-2xl group ' +
    className}
...
>
  ...
  <span class="relative pr-6"><slot /><NavImage {src} {alt} {outline}/></span>
