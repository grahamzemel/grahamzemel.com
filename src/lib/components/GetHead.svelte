...
{#if onProject}
    ...
    <div style="position: absolute;margin-bottom: 1%;margin-top:18%; margin-left:5.5%;">
      ...
      >
        <h5 class="!font-Inter !text-transparent !bg-clip-text !pr-5 !mt-2 !mb-5">
          <div id="shareButton" class="!text-[#494949] !dark:text-[#565656]">
            <SvelteCopyUrlButton
              icon={false}
              size="18"
              timeout="10000"
    ...
    <div style="position: absolute;margin-bottom: 1%;margin-top:45%; margin-left:5.5%;">
      ...
      <ul class="text-lg sm:text-[1rem] !font-Inter !text-transparent bg-clip-text bg-[#778899]">
        ...
        <li>
          <div class="flex justify-between">
            <ButtonLink href={`https://grahamzemel.gumroad.com/l/thegrayareapremium/`}>Premium Newsletter</ButtonLink>
            <hr />
          </div>
        </li>
      </ul>
...
{:else}
  ...
  <div style="position: absolute;margin-bottom: 1%;margin-top:70%; margin-left:5.5%;">
    ...
    <h2
      style="font-size: 1.7rem;line-height: 2.25rem;"class="!font-Inter !text-transparent bg-clip-text bg-black dark:bg-white"
    >
      Recent Projects
      <hr />
    </h2>
